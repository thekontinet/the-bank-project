            ...
            <div class="container-fluid p-0">
                <div class="overview-box">
                    ...
                    <div class="overview-image">
                        <div class="image">
                            <img src="{{theme_asset('')}}assets/img/1.png" alt="image">
        ...
        <section class="services-area ptb-70 bg-f7fafd">
            <div class="container-fluid p-0">
                <div class="overview-box">
                    <div class="overview-image">
                        <div class="image">
                            <img src="{{theme_asset('')}}assets/img/2.png" alt="image">
                ...
                <div class="overview-box">
                    <div class="overview-content">
                        <div class="content left-content">
                            ...
                            <div class="bar"></div>
                            <p>We render top class services to all our corporate customers, providing world class business products at their disposal.</p>
                    ...
                    <div class="overview-image">
                        <div class="image">
                            <img src="{{theme_asset('')}}assets/img/3.png" alt="image">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-sm-6 col-md-6">
                        <div class="single-features-box">
                            ...
                            <p>Easily retrive your banking information, transaction history, account statement e.t.c from our platform.</p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 col-sm-6 col-md-6">
                        <div class="single-features-box">
                            ...
                            <p>Get reminded on payment deadlines, bills deadlines and easily schedule auto payments on our platform.</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6 col-md-12">
                        <div class="invoicing-content">
                            <h2>SME Loans</h2>
                            <div class="bar"></div>
                            <p>We are commited to Small and medium Businesses to rise and grow hence we provide soft loans to the owners of such businesses to help them grow. We also provide business consulting professionals to teach the owners of such businesses on how best to run their businesses.</p>
                    ...
                    <div class="col-lg-6 col-md-12">
                        <div class="invoicing-image">
                            <div class="main-image">
                                <img src="{{theme_asset('')}}assets/img/invoicing-image/1.png" class="wow animate__animated animate__zoomIn" alt="image">
                                <img src="{{theme_asset('')}}assets/img/invoicing-image/2.png" class="wow animate__animated animate__fadeInLeft" alt="image">
                                <img src="{{theme_asset('')}}assets/img/invoicing-image/3.png" class="wow animate__animated animate__fadeInLeft" alt="image">
                                <img src="{{theme_asset('')}}assets/img/invoicing-image/4.png" class="wow animate__animated animate__fadeInRight" alt="image">
                            </div>
                            <div class="main-mobile-image">
                                <img src="{{theme_asset('')}}assets/img/invoicing-image/main-pic.png" class="wow animate__animated animate__zoomIn" alt="image">
                            </div>
				...
				<div class="feedback-slides">
						...
						<div>
							...
							<div class="item">
								<div class="single-feedback">
									...
									<p>I was hesitant to switch banks after so many years, but I'm so glad I did. The customer service at this bank is top-notch, and they've helped me save money on fees and other expenses.</p>
								</div>
							</div>
							...
							<div class="item">
								<div class="single-feedback">
									...
									<p>I appreciate the security measures that this bank takes to protect my personal and financial information. Their online banking platform uses the latest encryption technology and two-factor authentication, so I feel confident banking with them.</p>
								</div>
							</div>
					...
					<div class="client-thumbnails">
						<div>
							...
							<div class="item">
								<div class="img-fill"><img src="{{theme_asset('')}}assets/img/client-image/4.jpg" alt="client"></div>
							</div>
