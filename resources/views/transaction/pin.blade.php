        ...
        <div class="flex items-center min-h-[450px]">
          ...
          >
            ...
            <div class="w-full md:w-1/2">
              <div class="max-w-md p-4 space-y-3 text-center">
                <h2
                  class="text-3xl font-bold font-heading text-muted-800 dark:text-white"
                >
                  Transaction Pin
                </h2>
                <p class="font-sans text-muted-500 dark:text-muted-400">
                  Enter your four digit transaction pin to confirm and proceed with this transaction
                </p>
                <!--Form-->
                <form method="post" action="{{route('transactions.update', $transaction->id)}}" class="pb-6 space-y-4 text-center">
                    @csrf
                    @method('put')
                  <!--Field-->
                  <div class="relative">
                    <div class="relative w-full rounded-md shadow-sm group">
                      <input
                        name="transaction_pin"
                        class="w-full h-10 py-2 pl-10 pr-4 text-center placeholder-gray-300 transition-all duration-300 bg-white border rounded-md dark:bg-muted-1000 border-muted-300 text-muted-600 focus:border-muted-300 focus:shadow-lg dark:placeholder-gray-600 dark:bg-muted-900 dark:text-muted-200 dark:border-muted-800 dark:focus:border-muted-800 tw-accessibility"
                        placeholder="****"
                        type="password"
                        size="4"
                        maxlength="4"
                      ...
                      <button
                        type="button"
                        class="absolute top-0 left-0 flex items-center justify-center w-10 h-10 transition-colors duration-300 cursor-pointer text-muted-400 dark:text-muted-600 group-focus-within:text-primary-500"
                      >
                        <i class="w-4 h-4 iconify" data-icon="lucide:key"></i>
                      </button>
                    </div>
                  ...
                  <button
                    type="submit"
                    class="inline-flex items-center justify-center w-32 h-10 px-6 py-2 font-sans text-sm text-white transition-all duration-300 rounded-full shadow-lg gap-x-2 bg-primary-500 shadow-primary-500/20 hover:shadow-xl tw-accessibility"
                  >
                    <span>Continue</span>
                  </button>
                </form>
            ...
            <div class="w-full md:w-1/2">
              <div class="max-w-sm mx-auto text-primary-500">
                ...
                >
                  <defs>
                    <style>.clip-path-0{-webkit-clip-path:url(#clip-path);clip-path:url(#clip-path)}.clip-path-1{-webkit-clip-path:url(#clip-path-2);clip-path:url(#clip-path-2)}.clip-path-3{-webkit-clip-path:url(#clip-path-3);clip-path:url(#clip-path-3)}.clip-path-4{-webkit-clip-path:url(#clip-path-4);clip-path:url(#clip-path-4)}.clip-path-5{-webkit-clip-path:url(#clip-path-5);clip-path:url(#clip-path-5)}.clip-path-6{-webkit-clip-path:url(#clip-path-6);clip-path:url(#clip-path-6)}</style>
