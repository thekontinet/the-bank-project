                    ...
                    <div
                        ...
                        <div class="flex items-start gap-2">
                            <div
                                ...
                                <img class="object-cover rounded-full w-14 h-14" src="{{$user->avatar}}" alt="avatar">
                            </div>
                            <div>
                                <h5
                                ...
                                <p class="font-sans text-sm text-muted-400">{{$user->accounts_count}} {{Str::of('Account')->plural($user->accounts_count)}}<p>
                            </div>
                        </div>
                        <div class="flex flex-col justify-start gap-4 mt-4 divide-y">
                            <a class="flex items-center gap-2 pt-2" href='{{route('admin.users.edit', $user->id)}}' title='user settings'>
                            ...
                            <a class="flex items-center gap-2 pt-2" href='{{route('admin.accounts.index', ['user_id' => $user->id])}}' title='user accounts'>
                                <i class="w-6 h-6 iconify text-slate-300" data-icon="lucide:wallet"></i>
                                <span class="text-sm dark:text-muted-100">Accounts</span>
                            </a>
                            <a class="flex items-center gap-2 pt-2" href='{{route('admin.tokens.index', ['user_id' => $user->id])}}' title='tokens'>
                            ...
                            <a class="flex items-center gap-2 pt-2" href='{{route('admin.mail.create', ['user_id' => $user->id])}}' title='send mail'>
