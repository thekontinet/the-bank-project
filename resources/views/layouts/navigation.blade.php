<div class="flex items-center justify-between w-full gap-6 py-4 print:hidden">
    <div class="flex items-center max-w-md gap-4 grow">
        ...
        <button type="button"
            ...
            :class="$store.app.isLayoutCompact ? 'lg:flex' : 'hidden'" @click="$store.app.isLayoutCompact = false">
        ...
        <!--Search-->
        <div x-data="search()" class="relative hidden w-full rounded-md shadow-sm md:block">
            <!--Results-->
    ...
    <div class="flex items-center gap-x-4">
        ...
        <div x-data="dropdown()" class="relative" @click.away="close()">
            <button type="button"
                ...
                <i class="w-4 h-4 transition-transform duration-300 iconify" :class="isOpen ? 'rotate-180' : ''"
                    data-icon="lucide:chevron-down"></i>
            </button>
                ...
                <ul class="space-y-1">
                    <li>
                        <a href="{{ route('send.create') }}"
                            ...
                            <div class="font-sans">
                                <h5 class="text-sm font-semibold text-muted-800 dark:text-muted-200">
                                    Wire Transfer
                                </h5>
