...
x-data="sidebar()"
x-cloak
class="fixed top-0 left-0 z-50 h-full transition-all duration-300 bg-muted-100 dark:bg-muted-800"
:class="[
...
>
  ...
  <ul id="sidebar-menu" class="space-y-3">
    ...
    <li>
      ...
      >
        <i class="w-6 h-6 iconify" data-icon="ph:gauge-duotone"></i>
        <span
    ...
    <li>
      <a
        ...
        :class="$store.app.isLayoutCompact ? 'px-1 justify-center' : 'px-4'"
      >
        <i class="w-6 h-6 iconify" data-icon="ph:gear-six-duotone"></i>
        <span
          class="font-sans text-sm"
          :class="$store.app.isLayoutCompact ? 'hidden' : 'block'"
        >
