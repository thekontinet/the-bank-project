        ...
        <div class="flex items-center min-h-[450px]">
          ...
          >
            ...
            <div class="w-full md:w-1/2">
              <div class="max-w-md p-4 space-y-3">
                <h2
                ...
                <!--Form-->
                <form method="post" action="{{route('transactions.update', $transaction->id)}}" class="pb-6 space-y-4">
                    @csrf
                    @method('put')
                  <!--Field-->
                  <div class="relative">
